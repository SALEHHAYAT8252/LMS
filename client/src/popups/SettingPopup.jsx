...
const SettingPopup = () => {
  ...
  return (
     <div className="fixed inset-0 bg-black/70 bg-opacity-0 p-5 flex items-center justify-center z-50">
            <div className="w-full bg-white rounded-lg shadow-lg sm:w-auto lg:w-1/2 2xl:W-1/2">
              <div className="p-6">
