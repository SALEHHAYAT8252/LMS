...
export const fetchAllBooks = () => async (dispatch) => {
  ...
  await axios
    .get("https://lms-server-synr.onrender.com/api/v1/book/all", { withCredentials: true })
    .then((res) => {
...
export const addBook = (data) => async (dispatch) => {
  ...
  await axios.post("https://lms-server-synr.onrender.com/api/v1/book/admin/add", data, {
